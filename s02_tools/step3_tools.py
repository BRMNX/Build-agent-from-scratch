...
def run_write(path: str, content: str) -> str:
    try:
        ...
        # Use file_path.parent() to find the parent of file_path.
        # Eg: file_path = project/src/test.py
        #     file_path.parent = project/src/
        # Use mkdir() to create file_path.parent if it not exists.
        # parents = True : if file_path.parent not exists, the function will create.
        # exist_ok = True : if file_path.parent already exists, make sure that the programme continues. 
        #                   Without this parameter, the programme will raise an error.
        file_path.parent.mkdir(parents=True, exist_ok=True)
        file_path.write_text(content, encoding="utf-8")
        # Notice:
        # write_text() will completely cover the original contents. 
...
def run_edit(path: str, old_text: str, new_text: str) -> str:
    try:
        ...
        """
        text.replace(old_text : str, new_text : str, count : int = -1) -> str
        Args:
            - count : int = -1 | Relpace all occurances. Set count = 1 to relpace the first occurance.
        """
